...
class ProductController extends Controller
{
    ...
    public function getPrice(Request $request, $productId)
    {
        ...
        $price = $stock ? $stock->selling_price ?? $stock->product->selling_price : '-';
    ...
    public function getDetails(Product $product)
    {
        ...
        $attributes = $product->stocks
            ...
            $html = view('site.partials.product_modal', ['product' => $product, 'attributes' => $attributes, 'defaultStockId' => $defaultStock->id])->render();
