...
@section('title')
    {{ trans('new_arrival.add_new_arrival') }}
@endsection
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('new_arrival.add_new_arrival') }}</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.new_arrivals.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="col-md-3">
                                                <label>
                                                    <input type="checkbox" name="product_ids[]" class="product-checkbox"
                                                        value="{{ $product->id }}"
                                                        @if ($new_arrivals->contains('product_id', $product->id)) checked @endif>
                                                    {{ $product->name }}
                                                </label>
                                            </div>
                                        @endforeach
