...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            @canany(['edit_settings'])
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                        <i class="side-menu__icon fe fe-settings"></i>
                        &nbsp;&nbsp;<span class="side-menu__label">{{ trans('settings.settings') }}</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('edit_settings')
                            <li><a class="slide-item"
                                    href="{{ route('admin.settings.edit') }}">{{ trans('settings.settings') }}</a>
                            </li>
                            <li><a class="slide-item"
            ...
            @canany(['view_faq', 'add_faq', 'edit_faq', 'delete_faq', 'active_faq', 'restore_faq'])
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
