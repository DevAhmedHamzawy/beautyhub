        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('product.products') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                            <a class="btn btn-primary text-white" href="{{ route('admin.products.create') }}">
                                {{ trans('product.add_new_product') }}
                            </a>
                            &nbsp;&nbsp;
                            <a class="btn btn-primary text-white" href="{{ route('admin.products.trash') }}">
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">{{ trans('product.category') }}</th>
                                    <th class="border-bottom-0">{{ trans('product.subcategory') }}</th>
                                    <th class="border-bottom-0">{{ trans('product.brand') }}</th>
                                    <th class="border-bottom-0">{{ trans('product.sku') }}</th>
                                    <th class="border-bottom-0">{{ trans('product.barcode') }}</th>
                                    <th class="border-bottom-0">{{ trans('product.price') }}</th>
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>{{ $product->category->parent->translate($locale)->name }}</td>
                                        ...
                                        @canany(['view_product', 'edit_product', 'delete_product', 'active_product',
                                            ...
                                            <td class="row pl-3">
                                                ...
                                                @can('active_product')
                                                    @if ($product->active == 1)
                                                        <a href="{{ route('admin.products.active', $product->id) }}"
