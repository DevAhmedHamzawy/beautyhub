        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.units.index') }}">{{ trans('unit.units') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ trans('unit.trashed_units') }}</li>
                </ol>
            </nav>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">{{ trans('unit.trashed_units') }}</h4>

                        <a class="btn btn-primary text-white" href="{{ route('admin.units.index') }}">
                            {{ trans('unit.units') }}
                        </a>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($units as $unit)
                                    <tr>
                                        ...
                                        @can('restore_unit')
                                            <td class="row pl-3">
                                                <a href="{{ route('admin.units.restore', $unit->id) }}" class="btn btn-primary"
