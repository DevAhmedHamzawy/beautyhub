...
@section('title')
    {{ trans('top_selling.add_top_selling') }}
@endsection
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('top_selling.add_top_selling') }}</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.top_sellings.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="col-md-3">
                                                <label>
                                                    <input type="checkbox" name="product_ids[]" class="product-checkbox"
                                                        value="{{ $product->id }}"
                                                        @if ($top_sellings->contains('product_id', $product->id)) checked @endif>
                                                    {{ $product->name }}
                                                </label>
                                            </div>
                                        @endforeach
