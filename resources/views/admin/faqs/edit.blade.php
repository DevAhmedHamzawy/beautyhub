        ...
        <div class="col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('faq.update_faq') }}</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="main-content-label mg-b-5">
                        {{ trans('faq.update_faq') }} {{ $faq->translate($locale)->question }}
                    </div>
                                    ...
                                    <div class="col-md-12 mg-t-10 mg-md-t-0">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('translations.' . $locale . '.question', $faq->translate($locale)->question) }}">
                                    ...
                                    <div class="col-md-12 mg-t-10 mg-md-t-0">
                                        <div class="form-group">
                                            ...
                                            <textarea name="translations[{{ $locale }}][answer]"
                                                ...
                                                rows="10">{{ old('translations.' . $locale . '.answer', $faq->translate($locale)->answer) }}</textarea>
