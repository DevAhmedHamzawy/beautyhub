        ...
        <div class="col-xl-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a
                            href="{{ route('admin.cities.index', $country) }}">{{ $locale == 'ar' ? $country->name : $country->english }}</a>
                    </li>
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex">
                            ...
                            &nbsp;&nbsp;
                            <a class="btn btn-primary text-white" href="{{ route('admin.cities.trash', $country->id) }}">
...
@section('js')
    ...
    <script>
        ...
        const table = $('#example-ajax').DataTable({
            processing: true,
            ajax: '{{ route('admin.cities.index', $country->id) }}',
            columns: [{
                    data: 'name',
                    name: 'name'
                },
        ...
        $('#createUnitForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '{{ route('admin.cities.store', $country->id) }}',
                method: 'POST',
                data: $(this).serialize(),
                success: function() {
                    swal({
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $.get('/admin/countries/' + country_id + '/cities/' + id + '/edit', function(data) {
        ...
        $('#editUnitForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/admin/countries/' + {!! $country->id !!} + '/cities/' + id,
                method: 'POST',
                data: formData,
                success: function() {
                    swal({
