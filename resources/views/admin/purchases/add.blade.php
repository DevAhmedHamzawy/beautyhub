        ...
        <div class="col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('purchase.add_new_purchase') }}</li>
                </ol>
            </nav>
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                                    ...
                                    <div class="bg-gray-200">
                                        <div class="form-group">
                                            ...
                                            <select name="status"
                                                ...
                                                <option value="pending">{{ trans('purchase.pending') }}</option>
                                                <option value="completed">{{ trans('purchase.completed') }}</option>
                            ...
                            <div class="row row-xs">
                                ...
                                <div class="col-lg-4">
                                    <div class="bg-gray-200">
                                        <div class="form-group">
                                            <input type="text" placeholder="{{ trans('purchase.discount') }}"
