...
@section('title')
    {{ trans('best_sell_week.add_best_sell_week') }}
@endsection
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ trans('best_sell_week.add_best_sell_week') }}</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.best_sell_weeks.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                                            ...
                                            <div class="col-md-3">
                                                <label>
                                                    <input type="checkbox" name="product_ids[]" class="product-checkbox"
                                                        value="{{ $product->id }}"
                                                        @if ($best_sell_weeks->contains('product_id', $product->id)) checked @endif>
                                                    {{ $product->name }}
                                                </label>
                                            </div>
                                        @endforeach
