 ...
 <script src="{{ asset('site/assets/js/jquery_3.7.1.min.js') }}"></script>

 <script src="{{ asset('site/assets/js/bootstrap_5.3.2.bundle.min.js') }}"></script>

 <script src="{{ asset('site/assets/js/nouislider.min.js') }}"></script>

 <script src="{{ asset('site/assets/js/aos-3.0.0.js') }}"></script>
