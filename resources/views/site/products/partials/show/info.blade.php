              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="product-info-content" data-aos="fade-left">
                          ...
                          <div class="ratings">
                              @php
                                  $rating = round($product->ratings_avg_rating ?? 0);
                          ...
                          <p class="content-paragraph">
                              {{ $product->translate($locale)->mini_description }}
                          </p>
                          <hr />
                          ...
                          @foreach ($attributes as $attribute)
                              @php
                                  ...
                                  $selectedValue = collect($attribute['values'])->firstWhere(
                                      'id',
                                      $attribute['selected'],
                                  );
                                      ...
                                      <div class="review-form">
                                          ...
                                          <div class="login-btn text-center">
                                              <a href="#" onclick="modalAction('.action')"
                                                  class="shop-btn">Submit Report</a>
                                          </div>
                                      </div>
                                  </div>
                              </div>
