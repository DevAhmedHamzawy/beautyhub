        ...
        <div class="product-wrapper" data-aos="fade-up">
            <div class="product-img">
                ...
                <div class="product-cart-items">
                    <a href="javascript:void(0)" class="cart cart-item" onclick="openProductModal(`{{ $product->slug }}`)">
                        <span>
                    ...
                    <a href="javascript:void(0);" data-slug="{{ $product->slug }}"
                        data-in-compare="{{ in_array($product->id, $compare) ? '1' : '0' }}" class="compaire cart-item">
                        <span>
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <rect width="40" height="40" rx="20" fill="white" />
