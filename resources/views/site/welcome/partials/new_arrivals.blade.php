                      ...
                      <div class="col-lg-3 col-sm-6">
                          <div class="product-wrapper" data-aos="fade-up">
                              <div class="product-img">
                                  <img src="{{ asset($new_arrival->img_path) }}" alt="product-img" />
                                  <div class="product-cart-items">
                                      <a href="javascript:void(0)" class="cart cart-item"
                                          onclick="openProductModal(`{{ $new_arrival->slug }}`)">
                                          <span>
                                      ...
                                      <a href="javascript:void(0)" data-slug="{{ $new_arrival->slug }}"
                                          data-in-wishlist="{{ auth()->user()?->wishlist->contains($new_arrival->id) ? '1' : '0' }}"
                                      ...
                                      <a href="javascript:void(0);" data-slug="{{ $new_arrival->slug }}"
                                          data-in-compare="{{ in_array($new_arrival->id, $compare) ? '1' : '0' }}"
                              ...
                              <div class="product-info">
                                  <div class="ratings">
                                      <span>
                                          @php
                                              $rating = round($new_arrival->averageRating());
                                          @endphp
                                  ...
                                  <div class="product-description">
                                      <a href="{{ route('products.show', $new_arrival->slug) }}"
                                          class="product-details">{{ $new_arrival->translate($locale)->name }}
                                      </a>
                                      <div class="price">
                                          ...
                                          @else
                                              ...
                                              <span
                                                  class="new-price">{{ $new_arrival->the_price['discounted'] }}</span>
                                          @endif
                                      </div>
                                  </div>
                              </div>
